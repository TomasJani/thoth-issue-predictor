"""Implement inspection recover from Amun."""
...
def check_status(inspection_id: str) -> Status:
    """Get status of inspection with given id from Amun."""
    ...
    logging.warning("Inspection with id %s was not loaded successfully.", inspection_id)
    return Status.UNFINISHED


def get_specification(inspection_id: str):
    """Get specification of request with given id from Amun."""
...
def get_result(inspection_id: str, batch_size: int):
    """Get result of inspection with given id from Amun."""
